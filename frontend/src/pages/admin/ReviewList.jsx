          ...
          <div className="flex items-center gap-3 flex-wrap">
            ...
            <div className="relative z-10">
              <select
                ...
                className="appearance-none bg-white border border-gray-300 rounded-lg px-3.5 py-2.5 pr-8 text-sm text-gray-700 cursor-pointer hover:border-gray-400 transition-all min-w-[180px]"
              >
            ...
            <div className="relative z-10">
              <select
                ...
                className="appearance-none bg-white border border-gray-300 rounded-lg px-3.5 py-2.5 pr-8 text-sm text-gray-700 cursor-pointer hover:border-gray-400 transition-all min-w-[140px]"
              >
