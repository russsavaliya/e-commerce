...
import DraftOrderList from './pages/admin/DraftOrderList';
...
const ADMIN_ROUTES = [
  ...
  {
    path: 'draft-orders',                      // URL path (will be /admin/draft-orders)
    component: DraftOrderList,                  // The component to show
    description: 'Draft Orders List Page'
  },
  // ============================================
